...
describe("caesarCipher", () => {
  ...
  //   it("should go to the last alphabet letter when the index gets negative in the decryption process", () => {
  //     const currentIndex = -4;
  //     const indexAfterValidation = caesarCipher().checkNegativeIndex(
  //       currentIndex
  //     );
  ...
  describe("encrypt", () => {
    it("should encrypt a message", () => {
      expect(caesarCipher().encrypt("Hello world, I'm learning Jest")).toEqual(
  ...
  describe("decrypt", () => {
    it("should decrypt a message", () => {
      expect(caesarCipher().decrypt("Mjqqt btwqi, N'r qjfwsnsl Ojxy")).toEqual(
